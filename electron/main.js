...
function showExecutableChooser(title, version, executables) {
  ...
  executableChooserWindow.loadFile(path.join(__dirname, "../../src/assets/ui/executable-chooser.html"))
...
function createGameDetailsWindow(recordId) {
  ...
  if (VITE_DEV_SERVER_URL) {
    gameDetailsWindow.loadURL(VITE_DEV_SERVER_URL + '/gamedetails.html')
  } else {
    gameDetailsWindow.loadFile(path.join(__dirname, "../dist/renderer/gamedetails.html"))
  }
