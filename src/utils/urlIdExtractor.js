// Mirror of electron/db/urlIdExtractor.js -- ESM for the renderer, CJS for the
// main process. The two cannot share a module, the same constraint
// src/utils/ratingCategories.js lives with. tests/url-id-extractor.test.js
