const CustomBannerTemplate = ({ game, onSelect }) => {
  ...
  const children = [
    ...
    React.createElement("div", {
      key: "top-overlay",
      className:
        "absolute top-0 left-0 w-full h-[28px] bg-gradient-to-r from-blue-900 to-blue-700 opacity-80 z-10",
    }),
    // Bottom overlay
    React.createElement("div", {
      key: "bottom-overlay",
      className:
        "absolute bottom-0 left-0 w-full h-[28px] bg-gradient-to-r from-blue-900 to-blue-700 opacity-80 z-10",
    }),
      ...
      [
        ...
        React.createElement(
          "div",
          {
            ...
            className: "absolute top-0 left-0 flex items-center h-[28px]",
          },
          [
            React.createElement("div", {
              key: "engine",
              className:
                "text-white text-[11px] rounded-md px-3 py-1 ml-3 drop-shadow-md",
        ...
        game.isUpdateAvailable &&
          React.createElement(
            "button",
            {
              key: "update-button",
              className:
                "absolute top-[4px] right-3 w-[100px] h-[22px] bg-transparent border border-green-400 text-green-400 text-[11px] rounded-md z-30 pointer-events-auto",
              onClick: (e) => {
                e.stopPropagation();
        ...
        React.createElement(
          "div",
          {
            key: "bottom-right-content",
            className:
              "absolute bottom-0 right-0 flex items-center mr-3 h-[28px]",
          },
          [
