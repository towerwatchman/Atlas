const F95BannerTemplate = ({ game, onSelect }) => {
  ...
  const children = [
    ...
    React.createElement(
      'div',
      { key: 'body', className: 'relative w-full bg-[#1F2937] p-2 flex flex-col' },
      [
        // Labels
        React.createElement(
          'div',
          ...
          [
            ...
            React.createElement(
              ...
              [
                React.createElement(
                  'div',
                  { key: 'header-title', className: 'flex justify-between items-center' },
                  [
                ...
                React.createElement('div', {
                  ...
                  children: [
                    React.createElement('span', { className: 'fas fa-user mr-1' }),
        ...
        game.isUpdateAvailable &&
          React.createElement(
            ...
            {
              key: 'update-button',
              className: 'absolute top-2 right-2 w-[90px] h-[20px] bg-transparent border border-yellow-400 text-yellow-400 text-[10px] rounded-sm z-30 pointer-events-auto',
              onClick: (e) => {
                e.stopPropagation();
